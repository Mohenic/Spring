...
import kr.co.ch10.entity.User3Entity;
import kr.co.ch10.service.User3Service;
...
public class User3Controller {
	...
	public List<User3Entity> list() {
		List<User3Entity> user3 = service.selectUser3s();
		return user3;
	}
	...
	@PostMapping("/user3")
	public void insert(User3Entity user3) {
