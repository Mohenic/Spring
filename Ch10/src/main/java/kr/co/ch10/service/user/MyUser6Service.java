package kr.co.ch10.service.user;
...
import kr.co.ch10.dto.User6DTO;
import kr.co.ch10.mapper.User6Mapper;
...
public class MyUser6Service {
	...
	public User6DTO selectUser6(int req) {
		return mapper.selectUser6(req);
	}
